...
// 存檔到 localStorage
function save() {
    localStorage.setItem('pool_v22', JSON.stringify(pool)); localStorage.setItem('activeNurses_v22', JSON.stringify(activeNurses));
    localStorage.setItem('sched_v22', JSON.stringify(schedule)); localStorage.setItem('leaves_v22', JSON.stringify(leaves));
}
